...
class BatteryPageHome extends StatefulWidget {
  @override
  _BatteryPageState createState() => _BatteryPageState();
}

class _BatteryPageState extends State<BatteryPageHome> {
  ...
  void listenBatteryState() => subscription = battery.onBatteryStateChanged.listen(
  ...
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(
          title: Text('Savior: BatteryLevel'),
          centerTitle: true,
        ),
        body: Center(
          child: Column(
